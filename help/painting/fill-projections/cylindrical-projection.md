...
填充的圓柱形投影使得影像和圖案能在物體周圍投射。 它可以用來安裝柱子或柱子，以及像手臂這類有機形狀。
...
| **角度** | 控制圓柱體周邊的投影大小。 <div><img class="" data-preserve-html="true" id="root_content_flex_items_position_position-par_dx_table_row-r4-column-c1_dynamic_grid_items_grid-cell_position-par_image" src="../../assets/cylindrical-angle.gif"/></div> |
| **背面剔除** | 啟用背面剔除後，可以將投影以垂直於圓柱體的角度剔除。 硬度滑桿定義投影在中間角度（非完整90度）時的軟度。 <div><img class="" data-preserve-html="true" id="root_content_flex_items_position_position-par_dx_table_row-r5-column-c1_dynamic_grid_items_grid-cell_position-par_image" src="../../assets/cylindrical-proj.gif" width="500px"/></div> |
